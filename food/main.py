...
def solve_problem():
    ...
    constraints.add_constraints(variables['prepare'],variables['used'],variables['waste'],variables['unfull'] )
    
    objective = Objective(model, data)
    objective.set_objective(variables['used'],variables['waste'],variables['unfull'])
